    ...
    <div class="row">
        <div class="col-9 mx-auto">
            <div class="card card-body mt-4">
                <h6 class="mb-0">{{ __('Edit Permission') }}</h6>
                <p class="text-sm mb-0">{{ __('edit permission') }}</p>
                <hr class="horizontal dark my-3">
                <form wire:submit="editPermission" action="#" method="POST">
                    <div>
                    ...
                    <div>
                        <label class="mt-4">{{ __('Permission Description') }}</label>
                    ...
                    <div>
                        <label class="mt-4 form-label">{{ __('Permission Status') }}</label>
