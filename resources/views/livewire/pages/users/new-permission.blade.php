    ...
    <div class="row">
        <div class="col-9 mx-auto">
            <div class="card card-body mt-4">
                <h6 class="mb-0">{{ __('New Permission') }}</h6>
                <p class="text-sm mb-0">{{ __('Create new permission') }}</p>
                <hr class="horizontal dark my-3">
                <form wire:submit="addPermission" action="#" method="POST">
                    <div>
                    ...
                    <div>
                        ...
                        <p class="form-text text-muted text-xs ms-1">
                            {{ __('This is how others will learn about the permission, so make it good!') }}
                        </p>
                    ...
                    <div>
                        ...
                        <div class="@error('status') has-danger @enderror d-flex flex-column">
                            ...
                            <div  class="form-check">
                                <input wire:model.live="status" type="radio" class="form-check-input" name="status" id="inactive" value="INACTIVE">
                                <label class="custom-control-label" for="draft">{{ __('Inactive') }}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="{{ route('manage-permissions') }}" type="button" name="button"
                            class="btn btn-light m-0">{{ __('Back to List') }}</a>
                        <button type="submit" name="button"
                            class="btn bg-gradient-primary m-0 ms-2">{{ __('Create Permission') }}</button>
                    </div>
                </form>
            </div>
        </div>
