    ...
    <div class="row">
        <div class="col-9 mx-auto">
            <div class="card card-body mt-4">
                <h6 class="mb-0">{{ __('New User Attribute') }}</h6>
                <p class="text-sm mb-0">{{ __('Create new user attribute') }}</p>
                <hr class="horizontal dark my-3">
                <form wire:submit="addUserAttr" action="#" method="POST">
                    <div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="{{ route('manage-user-attrs') }}" type="button" name="button"
