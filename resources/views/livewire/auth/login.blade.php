                ...
                <div class="col-lg-4">
                    <div class="card z-index-0">
                        <div class="card-body">
                            ...
                            <div x-data="{ otpSent: false }"
                                x-init="$watch('otpSent', value => $wire.otpSent = value); $watch(() => $wire.otpSent, value => otpSent = value)">
                                ...
                                <form wire:submit.prevent="sendOtp">
                                    ...
                                    <div class="mb-3">
                                        <button x-show="!otpSent" class="btn btn-primary w-100" x-transition>
                                            Send OTP
                                        </button>

                                        <div x-show="otpSent" x-transition>
                                            <div class="mt-3 text-center text-success">OTP Sent!</div>
