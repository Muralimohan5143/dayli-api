{{-- resources/views/livewire/vendor-signup/steps/vendor-health_packs.blade.php --}}
@php
$subscriptionType = 'health_packs';
...
$subtypes = ['Diabetic Friendly Fruit Pack','Diabetic Friendly Veg Pack'];
...
'diabetic_friendly_veg_pack' => 179,
];
@endphp
