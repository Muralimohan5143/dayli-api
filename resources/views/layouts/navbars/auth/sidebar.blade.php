<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    id="sidenav-main" navbar-scroll="true">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('default') }}">
            <img src="../assets/img/eomdtm.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Dayli</span>
        </a>
    </div>
...
<li class="nav-item">
    <a href="{{ route('leads.create') }}" class="nav-link {{ Request::is('leads/create') ? 'active' : '' }}">
        ...
        <span class="nav-link-text ms-1">Create Lead</span>
    </a>
</li>
<li class="nav-item">
    <a href="{{ route('leads.index') }}" class="nav-link {{ Request::is('leads') ? 'active' : '' }}">
        ...
        <span class="nav-link-text ms-1">All Leads</span>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('leads.index') }}" class="nav-link {{ Request::is('leads') ? 'active' : '' }}">
        ...
        <span class="nav-link-text ms-1">All Leads</span>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#laravelExamples" class="nav-link {{ strpos(Request::route()->uri(), 'laravel') === false ? '' : 'active' }}"
                ...
                <div class="collapse show" id="laravelExamples">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item {{ Route::currentRouteName() ==='manage-prices' ? 'active' : '' }}">
                            <a class="nav-link {{ Route::currentRouteName() === 'manage-prices' ? 'active' : '' }}"
                                href="{{ route('manage-prices') }}">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Manage Prices </span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::currentRouteName() ==='manage-subscr-types' ? 'active' : '' }}">
                            <a class="nav-link {{ Route::currentRouteName() === 'manage-subscr-types' ? 'active' : '' }}"
                                href="{{ route('manage-subscr-types') }}">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Manage Subscription Types </span>
                            </a>
                        </li>
                        ...
                        <li
                            ...
                            <div class="collapse {{ !in_array(request()->route()->getName(), ['overview', 'all-projects', 'teams'])  ? '' : 'show' }}"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item {{ Request::route()->uri() === 'pages-profile-all-projects' ? 'active' : '' }}">
                        ...
                        <li
                            ...
                            <div class="collapse {{ !in_array(request()->route()->getName(), ['reports', 'new-user'])  ? '' : 'show' }} "
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item {{ Route::currentRouteName() ==='manage-user-attrs' ? 'active' : '' }}">
                                        <a class="nav-link {{ Route::currentRouteName() === 'manage-user-attrs' ? 'active' : '' }}"
                                            href="{{ route('manage-user-attrs') }}">
                                            <span class="sidenav-mini-icon"> D </span>
                                            <span class="sidenav-normal"> Manage User Attributes </span>
                                        </a>
                                    </li>
                                    @endcan
                                    @can('manage-permissions', App\User::class)
                                    <li class="nav-item {{ Route::currentRouteName() ==='manage-permissions' ? 'active' : '' }}">
                                        <a class="nav-link {{ Route::currentRouteName() === 'manage-permissions' ? 'active' : '' }}"
                                            href="{{ route('manage-permissions') }}">
                                            <span class="sidenav-mini-icon"> D </span>
                                            <span class="sidenav-normal"> Manage Permissions </span>
                                        </a>
                                    </li>
                                    @endcan
